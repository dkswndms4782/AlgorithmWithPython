...
| **2022.06.11일(토)** |    [미로탐색](https://www.acmicpc.net/problem/2178)    | BFS | ***And와 &*** <br /> ***And*** : lazy evaluation.<br/> -> if the first statement is False, it does not check the second statement. and returns False immediately <br/> ***&*** : bitwise<br/> [참고](https://www.geeksforgeeks.org/difference-between-and-and-in-python/) |
